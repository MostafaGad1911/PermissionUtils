...
class SuccessTickView : View {
    ...
    private var mMaxLeftRectWidth = 0f
    private var mLeftRectWidth = 0f
    private var mRightRectWidth = 0f
    private var mLeftRectGrowMode = false
    ...
    fun startTickAnim() {
        ...
        mRightRectWidth = 0f
        invalidate()
        val tickAnim: Animation = object : Animation() {
