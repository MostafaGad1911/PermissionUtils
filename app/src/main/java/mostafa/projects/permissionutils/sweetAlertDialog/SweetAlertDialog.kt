package mostafa.projects.permissionutils.sweetAlertDialog
...
import mostafa.projects.permissionutils.R
...
class SweetAlertDialog @JvmOverloads constructor(context: Context?, alertType: Int = NORMAL_TYPE) :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressHelper.progressWheel =
            findViewById<View>(R.id.progressWheel) as ProgressWheel
...
//        mConfirmButton.setBackgroundResource(R.drawable.blue_button_background);
    ...
    init {
        ...
        progressHelper = context?.let { ProgressHelper(it) }!!
        alerType = alertType
        mErrorInAnim = OptAnimationLoader.loadAnimation(getContext(), R.anim.error_frame_in)
        mErrorXInAnim =
            OptAnimationLoader.loadAnimation(getContext(), R.anim.error_x_in) as AnimationSet
        ...
        mModalInAnim =
            OptAnimationLoader.loadAnimation(getContext(), R.anim.modal_in) as AnimationSet
        mModalOutAnim =
            OptAnimationLoader.loadAnimation(getContext(), R.anim.modal_out) as AnimationSet
